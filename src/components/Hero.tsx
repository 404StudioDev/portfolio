...
export default function ProjectCard({
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="group relative w-[290px] h-[310px] cursor-pointer overflow-hidden rounded-lg bg-transparent border-none shadow-none transition-transform duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] hover:scale-[1.025]"
    >
      {/* Tricolor animated border layer */}
      <div
        style={{
          "--border-width": "1px",
          "--border-radius": "8px",
